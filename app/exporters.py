...
def export_report_pdf(report: CompetitorReport) -> str:
    ...
    story.extend(
        [
            ...
            Paragraph(report.recent_pivots, styles["BodyText"]),
            Spacer(1, 10),
            Paragraph("Sentiment Drift", styles["Heading2"]),
            Paragraph(report.sentiment_drift_analysis.summary, styles["BodyText"]),
        ]
    )
    ...
    story.extend(
        [
            ...
            Paragraph(report.tech_stack_fingerprinting.summary, styles["BodyText"]),
        ]
    )
